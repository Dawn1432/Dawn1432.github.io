...
### 解决！
- <font color="#660000">__404问题：__ </font> 非常坑爹，虽然没有使用github page提供的主题，但是还是必须去选一个主题，会看到它帮你更新了_config.yml文件，然后就解决了我朋友404的问题。另外，再次强调，工程名必须使用{$username}.github.io。![图](https://dawn1432.github.io/images/github博客创建纪念/choose_a_theme.png)
